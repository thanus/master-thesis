...
Code is generated from the \textit{Rebel} specifications with the use of code
generators. The problem with code generation is that the resulting
...
testing techniques to automatically generate tests, these improvements are done
