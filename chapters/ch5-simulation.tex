...
The sync expressions translated to the \gls{smt} solver are just logical formulas,
...
% actor systems -> goed messages doorvoeren, retry schema? distributed, resilient.
...
which is used for building highly concurrent, distributed and resilient
message-driven systems.~\cite{akka}
...
asynchrony is the nondeterminism of ordering and timing. That is to say, the
