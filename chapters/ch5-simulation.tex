...
by the \gls{sut}. For example, a generated pre- or postconditions aren't
satisfied by the execution from the traces.
...
\info{Why it's not possible to find faults? e.g. the setup of the sut, use more complex}
