...
\subsection{Bugs}
Expected: Find bugs where the inverse is possible. Just like the example from the test
mechanics.
\\
...
\subsection{Coverage}
Expected: To test all transitions with its state.
\\
