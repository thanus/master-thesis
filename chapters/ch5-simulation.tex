...
\info{explain sync stuff and about distribution, look at implementation of sync in smt. Theoretically it is possible to find errors in distributed stuff.}
...
Altogether, a generated tebl for checking the current state looks as follows in \autoref{fig:tebl-gen-validated-transaction}.
