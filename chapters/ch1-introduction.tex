...
\gls{sut}. These models represents the behaviours of a \gls{sut} and/or its
environment.~\cite{utting2012taxonomy, tretmans2008model}

After defining the model, test selection criteria needs to be defined to
transform this criteria into test case specifications. Test case specifications
describes on a high level the desired test case. Test cases are generated when
...
is already present. The model in \textit{Rebel} are the \textit{Rebel}
specifications. \textit{Rebel} specifications describes banking products and
...
In model-based testing, there exists several test generation technologies to
