...
In this experiment is the simulation used to test transitions. Since
...
\info{add information about testing synchronisation.
Why it's not possible to find faults? e.g. the setup of the sut, use more complex}
