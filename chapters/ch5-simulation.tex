...
for the \textit{interest} transition. The \textit{interest} transition fault in the Javadatomic
generator belongs to the fixed code category, but in this case, for the Scala-ES
generator, the fault belongs to the injected code category, since the
