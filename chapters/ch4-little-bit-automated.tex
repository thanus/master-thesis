...
the code, which is then the SUT.

The test case generator can be used to test the SUT, when the SUT is generated
...
In order to test the SUT, the test case generator performs a similar transition
as used within checking in the SUT. Finally, the results from checking and the
performed transition in the SUT are compared.
...
When we take a look at the account in the SUT, it looks as
